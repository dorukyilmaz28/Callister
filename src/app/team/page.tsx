...
export default function TeamPage() {
  ...
  const roleTranslations: { [key: string]: string } = {
    ...
    'Yazılım Kaptanı': t('team.roles.softwareCaptain') as string,
    'Mekanik Kaptanı': t('team.roles.mechanicalCaptain') as string,
    'Tasarım Kaptanı': t('team.roles.designCaptain') as string,
    'Tasarım ve Yazılım Geliştirici': t('team.roles.designAndSoftwareDeveloper') as string,
    'Tasarım': t('team.roles.designer') as string
  }
  ...
  const descriptionTranslations: { [key: string]: string } = {
    ...
    'Takım kaptanı ve yazılım ekibinde sorumlu.': t('team.descriptions.teamCaptain') as string,
    ...
    'Takım kaptanı.': t('team.descriptions.teamCaptainShort') as string,
    'Takım kaptanı; aynı zamanda yazılım ekibinde görev alıyor.': t('team.descriptions.teamCaptainAndSoftware') as string,
    'Yazılım kaptanı ve yazılım geliştirmeden sorumlu.': t('team.descriptions.softwareCaptainDesc') as string,
    'Mekanik kaptanı ve mekanik sistemlerden sorumlu.': t('team.descriptions.mechanicalCaptainDesc') as string,
    'Tasarım kaptanı; robot ve grafik tasarımından sorumlu.': t('team.descriptions.designCaptainDesc') as string
  }
