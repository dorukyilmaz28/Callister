        ...
        <div className="flex-1 py-20">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h1 className="text-5xl md:text-6xl font-bold text-white mb-4 drop-shadow-lg">{t('about.title')}</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-16">
              {[
                { icon: Calendar, value: t('about.content.foundedDate'), label: t('about.stats.foundedDate') },
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 shadow-2xl max-w-4xl mx-auto space-y-8">
              <section>
                <h2 className="text-2xl font-bold text-white mb-4 font-['Poppins']">{t('about.content.whoWeAre')}</h2>
                ...
                <p className="text-gray-200 font-['Poppins'] leading-relaxed">
                  {t('about.content.paragraph7')}
                </p>
                <p className="text-gray-200 font-['Poppins'] leading-relaxed">
                  {t('about.content.paragraph8')}
                </p>
                <p className="text-gray-200 font-['Poppins'] leading-relaxed">
                  {t('about.content.paragraph9')}
                ...
                <p className="text-gray-200 font-['Poppins'] leading-relaxed">
                  {t('about.content.paragraph10')}
                </p>
                <p className="text-gray-200 font-['Poppins'] leading-relaxed">
                  {t('about.content.paragraph11')}
                </p>
                <p className="mt-8 text-right font-bold text-purple-300 font-['Poppins']">{t('about.content.signature')}</p>
              </section>
            </div>
          </div>
        </div>
